...
(function (root, factory) {
    ...
    let globalWindow = typeof window !== 'undefined' && window.Math == Math
        ? window
    ...
    function forEachElement(elements, callback){
        ...
        let isCollectionTyped = (elementsType === '[object Array]'
    ...
    */
    ...
    var ResizeSensor = function(element, callback) {
        ...
        function attachResizeEvent(element, resized) {
            ...
            let position = computedStyle ? computedStyle.getPropertyValue('position') : null;
